...
client.on('message', message => {
        ...
        .setURL(`https://discordapp.com/api/oauth2/authorize?client_id=530402467737763840&permissions=8&scope=bot`)
    ...
    let memberavatar = member.user.avatarURL
      ...
      if(welcomer) {
        ...
        .addField(': تاريخ دخولك الدسكورد',`${moment(member.user.createdAt).format('D/M/YYYY h:mm a')} **\n** \`${moment(member.user.createdAt).fromNow()}\``,true)            
         ...
         .setFooter(`${h.tag}`,"https://cdn.discordapp.com/attachments/530390942973165591/530401356406587392/20190103_163404.jpg")
...
حآول العبث بالسيرفر ${channel.guild.name}`)
 ...
 channelr[channelremover.id].deleted = 0;
  ...
  client.on('message', message => { 
    ...
    .setFooter(`RedBot`, 'https://cdn.discordapp.com/attachments/530390942973165591/530401356406587392/20190103_163404.jpg')                                 
